...
public enum ErrorCode {
	...
	GR04("그룹 비밀번호를 수정 중 에러가 발생하였습니다."),
	MR01("그룹 매칭 도중 에러가 발생하였습니다.","/auto/form"),
	MR02("매칭된 그룹에 등록하는 도중 에러가 발생하였습니다.","auto/form"),
	MR03("그룹의 매칭정보를 변경하는 도중 에러가 발생하였습니다.","auto/form"),
	MR04("해당 조건을 만족하는 그룹을 찾지 못하였습니다.","auto/form"),
