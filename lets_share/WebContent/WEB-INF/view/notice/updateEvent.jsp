...
<div id="main"><%-- <div class="wrapper style1"> --%>
	...
	<div class="content_wrap">
		<div class="content">
			<form action="/notice/updateRequest" id="update" name="${notice.noticeNo}" method="post">
				<div class="form form_title">
					...
					<input type="text" name="title" required="required" value="${notice.noticeTitle}"/>
          		</div>
				<div class="form form_content">
		            <div class="form_space">내용</div>
		            <textarea rows="10" name="contents" required="required">${notice.noticeContent}</textarea>
				</div>
